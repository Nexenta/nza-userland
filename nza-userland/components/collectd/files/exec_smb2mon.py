...
collectd EXEC script that monitors SMB2 IO performance.
...
# Start subprocess
producer = subprocess.Popen(["/usr/local/collectd/bin/smb2mon.d",
...
while True:
    ...
    for key, value in stats.iteritems():
        sys.stdout.write('PUTVAL "%s/smb2mon/gauge-%s" interval=%s '
